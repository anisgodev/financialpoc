package com.tnbeit.cloud.gateway.backend.service;

import com.tnbeit.cloud.gateway.backend.config.Constants;
import com.tnbeit.cloud.gateway.backend.domain.Authority;
import com.tnbeit.cloud.gateway.backend.domain.User;
import com.tnbeit.cloud.gateway.backend.repository.AuthorityRepository;
import com.tnbeit.cloud.gateway.backend.repository.UserRepository;
import com.tnbeit.cloud.gateway.backend.security.SecurityUtils;
import com.tnbeit.cloud.gateway.backend.service.dto.AdminUserDTO;
import com.tnbeit.cloud.gateway.backend.service.dto.UserDTO;
